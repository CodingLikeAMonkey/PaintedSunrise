...
public static class DebugPrintStaticMeshesSystem
{
    ...
    {
        var query = world.Query<MeshStaticComponent, TransformComponent>();
        Log.PrintInfo("===== Static Meshes =====");

        query.Each((Entity e, ref MeshStaticComponent mesh, ref TransformComponent t) =>
        {
